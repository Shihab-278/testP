                            ...
                            <form id="selectToolForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="toolSelect" name="tool_id" required>
                                        ...
                                        <!-- Tools will be populated dynamically based on selected category -->
                                    </select>
                                </div>
                                <button type="submit" class="btn btn-primary">Generate Tool</button>
                            </form>
                        <?php endif; ?>
                    </div>
                </div>
...
<!-- JavaScript to update tool options based on selected category -->
        ...
        $('#selectToolForm').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#toolModal .modal-title').text(response.status === 'success' ? 'Tool Generated Successfully!' : 'Error');
                    $('#toolModal .modal-body').html(response.message);

                    if (response.status === 'success') {
                        $('#toolModal .modal-body').append(
                        ...
                        generatedToolsTable.empty(); // Clear the current table

                        // Append each generated tool to the table
                        ...
                        // Clear tool select dropdown
                        $('#toolSelect').html('<option value="" disabled selected>Select a tool</option>');
                    }
...
<!-- Modal to display tool generation success -->
