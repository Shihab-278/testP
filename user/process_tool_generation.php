...
function sendTelegramNotification($message)
{
    ...
    if ($settings) {
        ...
        // Handle case if Telegram settings are not found in the database
        error_log('Telegram settings not found.');
    }
}
...
$bangladeshTime = date('Y-m-d H:i:s'); // Format: YYYY-MM-DD HH:MM:SS
        ...
        if (!$tool) {
            ...
            if ($alreadyGenerated) {
                ...
                if ($user['balance'] < $tool['tool_cost']) {
                    ...
                    $message .= "═══════════════════════════════════\n\n";
                    $message .= "👤 Generated By: " . $username . "\n";
                    $message .= "🕰️ Generated At (Bangladesh Time): " . $bangladeshTime; // Add Bangladesh time
